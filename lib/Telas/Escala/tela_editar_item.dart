...
class TelaEditarItem extends StatefulWidget {
  const TelaEditarItem(
      {super.key,
      required this.locaisTrabalhoCooperadores,
      required this.nomeEscalaSelecionada});

  final String nomeEscalaSelecionada;
  final LocaisTrabalhoCooperadores locaisTrabalhoCooperadores;

  @override
  State<TelaEditarItem> createState() => _TelaEditarItemState();
}

class _TelaEditarItemState extends State<TelaEditarItem> {
  ...
  void initState() {
    super.initState();
    if (widget.locaisTrabalhoCooperadores.primeiroHorarioPulpito == " " ||
        widget.locaisTrabalhoCooperadores.segundoHorarioPulpito == " ") {
  ...
  preencherCampos() {
    dataSelecionada = DateFormat("dd/MM/yyyy EEEE", "pt_BR")
        .parse(widget.locaisTrabalhoCooperadores.data);
    ctPrimeiroHoraPulpito.text =
        widget.locaisTrabalhoCooperadores.primeiroHorarioPulpito;
    ctSegundoHoraPulpito.text =
        widget.locaisTrabalhoCooperadores.segundoHorarioPulpito;
    ctPrimeiroHoraEntrada.text =
        widget.locaisTrabalhoCooperadores.primeiroHorarioEntrada;
    ctSegundoHoraEntrada.text =
        widget.locaisTrabalhoCooperadores.segundoHorarioEntrada;
    ctRecolherOferta.text = widget.locaisTrabalhoCooperadores.recolherOferta;
    ctUniforme.text = widget.locaisTrabalhoCooperadores.uniforme;
    ctMesaApoio.text = widget.locaisTrabalhoCooperadores.mesaApoio;
    ctServirSantaCeia.text = widget.locaisTrabalhoCooperadores.servirSantaCeia;
    ctIrmaoReserva.text = widget.locaisTrabalhoCooperadores.irmaoReserva;
  }
    ...
    if (data.contains(Constantes.diaSabado) ||
      ...
      setState(() {
        horarioTroca = "${Textos.msgComecoHorarioEscala} "
            ...
            " ${Textos.msgTrocaHorarioEscala} ${prefs.getString(Constantes.shareHorarioTrocaFsemana) ?? ''} ";
      });
    } else {
      setState(() {
        horarioTroca = "${Textos.msgComecoHorarioEscala} "
  ...
  chamarAtualizarItem() async {
    widget.locaisTrabalhoCooperadores.data = formatarData(dataSelecionada);
    widget.locaisTrabalhoCooperadores.primeiroHorarioPulpito =
        ctPrimeiroHoraPulpito.text;
    widget.locaisTrabalhoCooperadores.segundoHorarioPulpito =
        ctSegundoHoraPulpito.text;
    ...
    widget.locaisTrabalhoCooperadores.segundoHorarioEntrada =
        ctSegundoHoraEntrada.text;
    widget.locaisTrabalhoCooperadores.recolherOferta = ctRecolherOferta.text;
    widget.locaisTrabalhoCooperadores.uniforme = ctUniforme.text;
    widget.locaisTrabalhoCooperadores.mesaApoio = ctMesaApoio.text;
    widget.locaisTrabalhoCooperadores.servirSantaCeia = ctServirSantaCeia.text;
    widget.locaisTrabalhoCooperadores.horarioTroca = horarioTroca;
    widget.locaisTrabalhoCooperadores.irmaoReserva = ctIrmaoReserva.text;
    bool retorno = await bancoDados.atualizarDados(
        widget.locaisTrabalhoCooperadores, widget.nomeEscalaSelecionada);
        ...
        child: WillPopScope(
          ...
          child: GestureDetector(
            ...
            child: Scaffold(
              appBar: AppBar(
                  elevation: 0,
                  title: Text(Textos.tituloTelaEditarItem),
                  leading: IconButton(
                    onPressed: () {
                      redirecionarTela();
                    },
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                              Textos.descricaoTelaEditarItem,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        height: 50,
                                        child: ElevatedButton(
                                          child: Text(Textos.btnAtualizarItem,
                                              textAlign: TextAlign.center,
                                              style: TextStyle(
                                                  color: corFundoTela)),
                                          onPressed: () {
                                            if (_formKeyFormulario.currentState!
                                                .validate()) {
                                              chamarAtualizarItem();
                                            }
                                          },
